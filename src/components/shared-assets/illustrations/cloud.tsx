    ...
    return (
        <div {...otherProps} className={cx("relative h-30 w-38", className)}>
            ...
            {children && (
                <span
                    className={cx(
                        "absolute inset-x-13 bottom-2 z-10 flex size-12 items-center justify-center rounded-full bg-primary_alt text-fg-secondary ring-1 ring-secondary shadow-xs",
                        childrenClassName,
                    )}
                >
                    {children}
    ...
    return (
        <div {...otherProps} className={cx("relative h-32 w-43", className)}>
            ...
            {children && (
                <span
                    className={cx(
                        "absolute bottom-3 left-1/2 z-10 flex size-14 -translate-x-1/2 items-center justify-center rounded-full bg-primary_alt text-fg-secondary ring-1 ring-secondary shadow-xs",
                        childrenClassName,
                    )}
                >
                    {children}
    ...
    return (
        <div {...otherProps} className={cx("relative h-40 w-55", className)}>
            ...
            {children && (
                <span
                    className={cx(
                        "absolute bottom-5 left-1/2 z-10 flex size-14 -translate-x-1/2 items-center justify-center rounded-full bg-primary_alt text-fg-secondary ring-1 ring-secondary shadow-xs",
                        childrenClassName,
                    )}
                >
                    {children}
